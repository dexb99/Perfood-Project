            ...
            <div className='justify-center w-full flex  items-center  foot-font'>
              <div className=' border-dashed rounded-lg justify-center w-[49%] px-3 flex items-center  foot-font'>
                <Link className=' items-center w-auto main-icon flex justify-center ' href="/Playgame">
                  <button type="button" class="text-white bg-gradient-to-br from-yellow-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-yellow-200 dark:focus:ring-yellow-800 font-extrabold rounded-lg text-base px-6 py-3.5 text-center mr-2 mb-2 inline-flex">
