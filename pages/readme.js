            ...
            <Row className='w-[30.5] h-[43.5]'>
              {Personaldata.map((personal) => (
                <Col key={personal.Personal_ID} className='p-2 bg-yellow-100 h-1/4 max-sm:w-1/2 md:w-1/4 xl:w-1/4 justify-center items-center'>
                  ...
                  <div className='justify-center text-center text-white radio-font'>
                    ...
                    <div className='justify-center items-center flex h-full'>
                      <div type="block" className='relative inline-flex items-center justify-center p-1 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-yellow-700 to-orange-400 '>
