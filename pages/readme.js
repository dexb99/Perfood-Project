      ...
      <Layout className='h-auto px-5 sm:px-5 md:px-[10%] xl:px-[20%] overflow-auto'>
          ...
          <Row className='w-[30.5] h-[43.5]'>
            {PersonalData.map((personal) => (
              <Col key={personal.id} className='p-2 bg-honeydew-300 h-1/4 max-sm:w-1/2 md:w-1/4 xl:w-1/4 justify-center items-center'>
                <div className='justify-center items-center border-dashed bg-green-400 rounded-lg p-2 h-full sm:p-0 md:p-[4%] xl:p-[8%] shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)]'>
                  <div className='justify-center items-center  flex h-full'>
                    <img className='w-[100%] h-{100%]' src={personal.Image} />
                  </div>
                  <div className='justify-center items-center flex h-full'>
                    <button type='button' class="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 group-hover:from-green-400 group-hover:to-blue-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800"  onClick={() => showDrawer(personal)}>
        ...
        <Footer className='bg-honeydew-300 flex justify-center items-center'>
          ...
          <Link className=' items-center w-auto main-icon flex justify-center ' href="/Homepage">
              <button type="button" class="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-extrabold rounded-lg text-base px-6 py-3.5 text-center mr-2 mb-2">Les't Go</button>
